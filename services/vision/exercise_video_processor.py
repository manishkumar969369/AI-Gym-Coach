...
class VideoProcessorClass(VideoProcessorBase):
    def __init__(self):
        ...
        print(self._exercise_type)
        # self._exercise_type = st.session_state.get("exercise_type", "Squats")
    ...
    def recv(self, frame):
        try:
            ...
            # print("Before Pose Detection")
            result = self._landmarker.detect_for_video(
                mp_image,
                self._frame_timestamps_ms
            )
            # print("After Pose Detection")
            ...
            if result.pose_landmarks:
                ...
                if detector:
                    # print("Before detector.process()")

                    metrics = detector.process(landmarks)

                    # print("After detector.process()")
