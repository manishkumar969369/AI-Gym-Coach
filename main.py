...
from services.state.session_defaults import initial_sessions_defaults
from services.config.workout_config import EXERXISE_OPTIONS
from services.ui.style_loader import load_css, inject_local_font, inject_webrtc_styles
import os
from services.persistence.exercise_repository import init_db
from streamlit_webrtc import webrtc_streamer,WebRtcMode
from services.ui.show import show
...
def main():
    ...
    with st.sidebar:
        ...
        if not workout_started:
            plan_exercise =  st.selectbox("Exercise",options=EXERXISE_OPTIONS, key="plan_exercise")
        ...
        if workout_started:
            ...
            st.metric("Set Comnpleted",f"{sets_completed} / {target_sets}")
            ...
            if exercise=="Biceps Curls (Dumbbell)":
                ...
                st.metric("Back Arc", f"{st.session_state.back_arch_status}")
                ...
                st.metric("Balance Status Arc", f"{st.session_state.balance_status}")
